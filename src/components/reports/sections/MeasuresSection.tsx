...
import { RotateCcw, GripVertical, CheckCircle, TrendingUp, Pencil, Copy } from "lucide-react";
      ...
      >
        ...
        <div key="measures-completed">
          <DraggableCard
            ...
            testId="tile-measures-completed"
        ...
        <div key="measures-progress">
          <DraggableCard
            ...
            testId="tile-measures-in-progress"
